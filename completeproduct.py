...
# ----------------------------------------------------------------------------------------------------
        ...
        #        =================Title====================
        title = Label(product_Frame,text="Products Detail",font=("goudy old style",18),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)
                # =================column1====================
        ...
        cmb_sup = ttk.Combobox(product_Frame,textvariable=self.var_supplier,values=self.supplier_list,state= 'readonly',justify=CENTER,font=("goudy old style",15))
...
#================================================================================================================================
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_cat.get()=="Select"or self.var_supplier.get()=="Select"or self.var_cat.get()=="Empty"or self.var_name.get()=="Select":
