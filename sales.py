...
class salesClass:
    def __init__(self,root): 
        ...
        self.bill_list = []
        #=========title=================
        lbl_title = Label(self.root,text="Customer Bill Reports",font=("goudy old style",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        lbl_title2 = Label(bill_Frame,text="Customer Billing Area",font=("goudy old style",20),bg="lightgreen").pack(side=TOP,fill=X)
