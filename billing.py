...
class BillClass:
    def __init__(self,root):
        ...
        pTitle =Label(ProductFrame1,text="All Products",font=("goudy old style",20,"bold"),bg="lightblue").pack(side=TOP,fill=X)
        ...
        lbl_search =Label(ProductFrame2,text="Search Product -- By Name",font=("goudy old style",15,"bold"),bg="white",fg="black").place(x=3,y=5)

        lbl_search = Label(ProductFrame2,text="Product Name",font=("goudy old style",15,"bold"),bg="white",fg="black").place(x=5,y=45)
        txt_search = Entry(ProductFrame2,textvariable=self.var_search,font=("goudy old style",15),bg="lightyellow",fg="black").place(x=131,y=49,width=150,height=22)

        btn_search = Button(ProductFrame2,text="Search",command=self.search,font=("goudy old style",15),bg="blue",fg="white",cursor="hand2").place(x=285,y=47,width=100,height=25)
        btn_show_all = Button(ProductFrame2,text="Show All",command=self.show,font=("goudy old style",15),bg="purple",fg="white",cursor="hand2").place(x=285,y=10,width=99,height=25)
 
        #=================Product Details Frame=================
        ProductFrame3 = Frame(ProductFrame1,bd=3,relief=RIDGE)
        ProductFrame3.place(x=2,y=140,width=398,height=378)
        ...
        cTitle =Label(CustomerFrame,text="Customer Details",font=("goudy old style",15),bg="lavender").pack(side=TOP,fill=X)
        lbl_name = Label(CustomerFrame,text="Name",font=("goudy old style",15),bg="white").place(x=5,y=35)
        txt_name = Entry(CustomerFrame,textvariable=self.var_cname,font=("goudy old style",13),bg="lightyellow",fg="black").place(x=80,y=35,width=180)

        lbl_contact = Label(CustomerFrame,text="Contact No.",font=("goudy old style",15),bg="white").place(x=270,y=35)
        txt_contact = Entry(CustomerFrame,textvariable=self.var_contact,font=("goudy old style",13),bg="lightyellow",fg="black").place(x=380,y=35,width=140)
        ...
        self.cartTitle =Label(cart_Frame,text="Cart \t Total Product: [0]",font=("goudy old style",15),bg="pink")
        ...
        lbl_p_price = Label(Add_CartWidgetsFrame,text="Price Per Qty",font=("times new roman",15),bg="white").place(x=215,y=5)
        txt_p_price = Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new roman",15),bg="lightyellow",state="readonly").place(x=215,y=35,width=150,height=22)
        ...
        bTitle =Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="lightblue").pack(side=TOP,fill=X)
        ...
        self.lbl_amnt = Label(billMenuFrame,text="Bill Amount\n[0]",font=("goudy old style",15,"bold"),bg='purple',fg="white")
        self.lbl_amnt.place(x=2,y=5,width=120,height=70)
        
        self.lbl_discount = Label(billMenuFrame,text="Discount\n[5%]",font=("goudy old style",15,"bold"),bg='green',fg="white")
        self.lbl_discount.place(x=124,y=5,width=120,height=70)
        
        self.lbl_net_pay = Label(billMenuFrame,text="Net Payable Amt\n[0]",font=("goudy old style",13,"bold"),bg='blue',fg="white")
        self.lbl_net_pay.place(x=246,y=5,width=150,height=70)
        
        
        btn_print = Button(billMenuFrame,text="Print",command=self.print_bill,cursor="hand2",font=("goudy old style",15,"bold"),bg='deeppink',fg="white",bd=5,relief=RAISED)
        btn_print.place(x=2,y=80,width=120,height=50)
        
        btn_clear_all = Button(billMenuFrame,text="Clear All",command=self.clear_all,cursor="hand2",font=("goudy old style",15,"bold"),bg='gray',fg="white",bd=5,relief=RAISED)
        btn_clear_all.place(x=124,y=80,width=120,height=50)
        
        btn_generate = Button(billMenuFrame,text="Generate/Save Bill",command=self.generate_bill,cursor="hand2",font=("goudy old style",12,"bold"),bg='black',fg="white",bd=5,relief=RAISED)
        
        btn_generate.place(x=246,y=80,width=150,height=50)
        # ===============================Footer==========================================
        footer = Label(self.root,text="INVENTORY MINDER | Developed by PYTHON PIRATES\nFor any Technical Issue Contact: 950xxxx987",font=('goudy old style',11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def bill_updates(self):
        ...
        self.lbl_net_pay.config(text=f"Net Payable Amt\nRs.{str(self.net_pay)}")
...
{str("="*45)}
 ...
 Net Payable Amount\t\t\t\tRs.{self.net_pay}
{str("="*45)}\n
        '''
