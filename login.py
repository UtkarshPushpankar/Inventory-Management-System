...
class Login_System:
    def __init__(self,root):
        ...
        self.root.title("Login System |  Developed by Kshitij & Utkarsh | PYTHON PIRATES")
        ...
        lbl_reg=Label(register_frame,text="Are you a new employee?",font=("times new roman",13),bg="white").place(x=50,y=15)
        btn_signup=Button(register_frame,text="Sign Up",font=("times new roman",13,"bold"),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E",cursor="hand2").place(x=230,y=13)
# ============================Animation Images================================================================
        self.im1=ImageTk.PhotoImage(file="images/1.png")
        self.im2=ImageTk.PhotoImage(file="images/99.png")
        ...
        try:
            if self.employee_id.get()=="" or self.password.get()=="":
                ...
                if user==None:
                    ...
                    if user[0]=="Admin":
                        self.root.destroy()
                        os.system("python CreatingDashboard(1).py")
                    else:
                        self.root.destroy()
