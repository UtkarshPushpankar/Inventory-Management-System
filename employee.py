...
class employeeClass:
    def __init__(self,root): 
        ...
        txt_empid = Entry(self.root,textvariable=self.var_emp_id,font=("goudy old style",15),bg="lightyellow").place(x=170,y=150,width=180)
        ...
        txt_name = Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=170,y=190,width=180)
        ...
        txt_email = Entry(self.root,textvariable=self.var_email,font=("goudy old style",15),bg="lightyellow").place(x=170,y=230,width=180)
        ...
        self.txt_adress.place(x=170,y=270,width=300,height= 60)
